 ...
 */
Handpoint.prototype.tokenizeCard = function(
  config,
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.saleAndTokenizeCard = function(
  config,
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.saleReversal = function(
  config,
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.refundReversal = function(
  config,
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.enableScanner = function(
  config,
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.cancelRequest = function(
  config,
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.tipAdjustment = function(
  config,
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.signatureResult = function(
  config,
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.disconnect = function(
  config,
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.setSharedSecret = function(
  config,
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.setParameter = function(
  config,
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.setLogLevel = function(
  config,
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.getDeviceLogs = function(
  config,
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.getPendingTransaction = function(
  config,
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.listDevices = function(
  config,
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.startMonitoringConnections = function(
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.stopMonitoringConnections = function(
  successCallback,
  errorCallback
) {
  // Deprecated: removed in hapi-android-4.0.0
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.applicationDidGoBackground = function(
  successCallback,
  errorCallback
) {
 ...
 * @param {Function} errorCallback This function will be called if an error happened
 */
Handpoint.prototype.getBluetoothStatus = function(
  successCallback,
  errorCallback
) {
  this.exec("getBluetoothStatus", {}, successCallback, errorCallback);
};
...
Handpoint.prototype.exec = function(
  method,
  config,
  successCallback,
  errorCallback
  ...
  if (errorCallback && typeof errorCallback != "function") {
    throw new Error(
      "Handpoint." + method + " failure: errorCallback is not a function"
    );
  }

  if (successCallback && typeof successCallback != "function") {
    throw new Error(
      "Handpoint." + method + " failure: successCallback is not a function"
    );
  }
